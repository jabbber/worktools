...
HEAD
echo "1)日常检查异常统计:<br/>"
${0%/*}/openimsi.py $1/开放平台开放平台日常检查异常统计表*.xlsx '分区日常检查异常明细-未备注/未处理' ~/none.txt ~/black.txt

echo "2)开放平台报警系统管理员后续处理跟踪:<br/>"
${0%/*}/openimsi.py $1/开放平台开放平台报警系统管理员后续处理跟踪表*.xlsx '未及时回复,昨日新增未回复'

echo "3)"
${0%/*}/openimsi.py $1/开放平台开放平台操作系统定义作业变化情况统计表*.xlsx '昨日Crontab新增'
