...
HEAD
echo "1)日常检查异常统计:<br/>"
${0%/*}/readxlsx.py $1/开放平台开放平台日常检查异常统计表*.xlsx '分区日常检查异常明细-未备注/未处理'

echo "2)"
${0%/*}/readxlsx.py $1/开放平台开放平台应用服务器到OPENIMIS报警连通情况统计表*.xlsx '没有接收到测试消息或者服务器到openimis报警有问题的系统'

echo "3)开放平台报警系统管理员后续处理跟踪:<br/>"
${0%/*}/readxlsx.py $1/开放平台开放平台报警系统管理员后续处理跟踪表*.xlsx '未及时回复,昨日新增未回复'

echo "4)"
${0%/*}/readxlsx.py $1/开放平台开放平台操作系统定义作业变化情况统计表*.xlsx '昨日Crontab新增'
